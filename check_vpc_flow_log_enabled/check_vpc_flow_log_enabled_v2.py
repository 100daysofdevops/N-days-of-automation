...
def enable_vpc_flowlogs(vpc_id):
    try:
        ...
        try:
            ...
            print(f"Log group with name: {log_group_name} already exists")
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser(description='Enable VPC Flow Logs for the specified VPC ID')
    parser.add_argument('vpc_id', help='VPC ID to enable flow logs for')
    args = parser.parse_args()

    enable_vpc_flowlogs(args.vpc_id)